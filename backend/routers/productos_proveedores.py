...
from database.productos_proveedores import obtener_productos_proveedores as obtener_productos_proveedores_db
from database.productos_proveedores import obtener_producto_proveedor as obtener_producto_proveedor_db
from database.productos_proveedores import crear_producto_proveedor as crear_producto_proveedor_db
from database.productos_proveedores import actualizar_producto_proveedor as actualizar_producto_proveedor_db
from database.productos_proveedores import eliminar_producto_proveedor as eliminar_producto_proveedor_db

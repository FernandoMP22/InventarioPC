...
from database.movimientos_inventario import obtener_movimientos_inventario as obtener_movimientos_inventario_db
from database.movimientos_inventario import obtener_movimiento_inventario as obtener_movimiento_inventario_db
from database.movimientos_inventario import crear_movimiento_inventario as crear_movimiento_inventario_db
from database.movimientos_inventario import actualizar_movimiento_inventario as actualizar_movimiento_inventario_db
from database.movimientos_inventario import eliminar_movimiento_inventario as eliminar_movimiento_inventario_db
